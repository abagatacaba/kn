...
export function variantAttributes(product) {
  ...
  return Object.fromEntries(Object.entries({ color: product.color, grade: product.grade, lebar: product.lebar, quality: product.variant }).filter(([k, v]) => v !== undefined && v !== null && v !== "" && !(k === "quality" && ["Regular", "Standard"].includes(v))));
}
