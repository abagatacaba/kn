        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-3">
          <div className="grid gap-3 sm:grid-cols-[180px_1fr]">
            <div className="relative">
              <ProductGallery product={selectedId ? selected : null} testId="quickview-gallery" compact />
          ...
          {axisMode ? (
            <VariantAxisPicker variants={variants} selectedId={selectedId} onSelect={(v) => { setSelectedId(v?.id || null); setMode('qty'); }} testIdPrefix="quickview" />
          ) : group.isMulti ? (
            <div>
