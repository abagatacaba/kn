...
export default function MobileQuickView({ group, specialMap = {}, onAdd, onClose, entityId = "",
  ...
  const blocked = !selectedId || blocksOrder(selected, rndEnforcement);
    ...
    <div className="m-sheet-wrap" data-testid="mobile-quickview">
      ...
      <div className="m-sheet">
        ...
        <div className="overflow-y-auto px-4 pb-4" style={{ maxHeight: "74vh" }}>
          <ProductGallery product={selectedId ? selected : null} testId="mobile-quickview-gallery" compact />
          ...
          {axisMode ? (
            <div className="mt-3">
              <VariantAxisPicker variants={variants} selectedId={selectedId} onSelect={(v) => { setSelectedId(v?.id || null); setMode('qty'); }} testIdPrefix="mobile-quickview" />
            </div>
          ) : group.isMulti ? (
            <>
